...
const projects = [
  ...
  },
  {
    ...
    codeLink:
      "https://github.com/SahilsPatil/Advance-AudioPhile-ECommerce-Website-With-Blind-Mode.git",
  ...
  },
  {
    ...
    codeLink:
      "https://github.com/SahilsPatil/Ayesha-International-React-js-Project-for-Client-.git",
  ...
  },
  {
    ...
    codeLink:
      "https://github.com/SahilsPatil/Login-Sign-up-Reset-Single-Page-Website-.git",
    projectLink:
      "https://sahilspatil.github.io/Login-Sign-up-Reset-Single-Page-Website-/",
  },
  {
    id: 10,
    img_name: image5,
    ...
    projectLink:
      "https://rock-paper-scissor-web-game-frontendentor-challange.netlify.app/",
  },
  {
    id: 11,
    img_name: image6,
  ...
  },
  {
    ...
    projectLink:
      "https://url-shortening-website-frontendmentor-challange.netlify.app/",
  },
  {
    id: 13,
    img_name: image10,
    ...
    codeLink:
      "https://github.com/SahilsPatil/freeCodeCamp-Responsive-Design-Projects.git",
    projectLink:
      "https://sahilspatil.github.io/freeCodeCamp-Responsive-Design-Projects/Personal%20Portfolio/index.html",
  },
  {
    id: 14,
    img_name: image11,
    ...
    codeLink:
      "https://github.com/SahilsPatil/freeCodeCamp-Responsive-Design-Projects.git",
    projectLink:
      "https://sahilspatil.github.io/freeCodeCamp-Responsive-Design-Projects/Product%20Landing%20Page/index.html",
  },
  {
    id: 15,
    img_name: image12,
    ...
    codeLink:
      "https://github.com/SahilsPatil/freeCodeCamp-Responsive-Design-Projects.git",
    projectLink:
      "https://sahilspatil.github.io/freeCodeCamp-Responsive-Design-Projects/Survey%20Form/index.html",
  },
  {
    id: 16,
    img_name: image13,
    ...
    codeLink:
      "https://github.com/SahilsPatil/freeCodeCamp-Responsive-Design-Projects.git",
    projectLink:
      "https://sahilspatil.github.io/freeCodeCamp-Responsive-Design-Projects/Technical%20Documentation%20Page/index.html",
  },
  {
    id: 17,
    img_name: image14,
    ...
    codeLink:
      "https://github.com/SahilsPatil/freeCodeCamp-Responsive-Design-Projects.git",
    projectLink:
      "https://sahilspatil.github.io/freeCodeCamp-Responsive-Design-Projects/tribute/index.html",
  },
  {
    id: 18,
    img_name: image15,
  ...
  },
  {
    ...
    codeLink:
      "https://github.com/SahilsPatil/Random-Password-Generator-with-Background-Changing-Feature",
    projectLink:
      "https://random-password-generator-with-background-changing.netlify.app/",
  },
  {
    id: 23,
    img_name: image20,
...
export default function Works(works) {
  ...
  return (
    <div className={styles.works}>
      <div
        className={styles.work_details_closer}
        style={work_details}
        onClick={() => viewProject(-1)}
      ></div>
      <Work_Details
        works={works.themeColor}
        work_details={work_details}
        links1={links.codeLink}
        links2={links.projectLink}
      />
  ...
  return projects.map((e) => {
    return (
      <div className={styles.works_work} key={e.id}>
        <div
          className={styles.works_work_image}
        ...
        <div className={styles.works_work_info}>
          <div
            className={styles.works_work_info_title}
            style={{ color: works.themeColor }}
          >
            {e.name}
          </div>
          <div className={styles.works_work_info_desc}>{e.Desc}</div>
          <div
            style={{
              display: "flex",
          ...
          >
            <div
              className={"works_work_info_btn"}
              style={{ border: "1.5px solid " + works.themeColor }}
              onClick={() => viewProject(e.id, e.codeLink, e.projectLink)}
            >
              View Project
            </div>
          </div>
