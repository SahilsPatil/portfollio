  ...
  return (
    <div className={styles.main}>
      <div className={styles.main_social}>
        <div>
          <a href="https://www.instagram.com/king_sahil_patil/">
            <Image
              className={styles.main_social_img}
              src={instagram}
              width={21}
              height={21}
            />
        ...
        <div>
          <a href="https://github.com/SahilsPatil">
            <Image
              className={styles.main_social_img}
              src={github}
              width={21}
        ...
        <div>
          <a href="https://www.linkedin.com/in/sahil-patil-753011246/">
            <Image
              className={styles.main_social_img}
              src={linkdin}
              width={21}
        ...
        <div>
          <a href="https://www.upwork.com/freelancers/~01647ac2cd3d95d59a">
            <Image
              className={styles.main_social_img}
              src={upwork}
              width={21}
      ...
      <div className={styles.main_contact}>
        <a href="mailto:sahilspatil6@gmail.com">
          <Image
            className={styles.main_contact_img}
            src={mail}
            width={30}
            height={30}
          />
        </a>
        <a href="tel:9175184390">
          <Image
            className={styles.main_contact_img}
            src={call}
            width={30}
